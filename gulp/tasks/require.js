...
var getConfigRequire = function(mode, app) {
	var	librariesToExcludeFromAppBuild = ['async','bootstrap','bootstrap-clickover','chart','card','chosen','clipboard', 'cookies','crossroads','config','dependClass','ddslick', 'drop', 'fileupload','footable','form2object','handlebars','hasher','hotkeys','introJs','isotope','jquery','jqueryui','jstz','kazoosdk','mask','modernizr','monster','monster-apps','monster-ui','monster-timezone','monster-routing','monster-ui','monster-util','mousetrap','nicescroll','papaparse','postal','prettify','renderjson','reqwest','signals','slider', 'tether', 'timepicker','toastr','touch-punch','lodash','validate','vkbeautify','wysiwyg','pdfjs-dist/build/pdf','pdfjs-dist/build/pdf.worker', 'templates'],
